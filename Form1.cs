...
namespace SimplePuzzleGame
{
    public partial class Form1 : Form
    {
        ...
        private void swapLabel(Object sender, EventArgs e)
        {
            ...
            if (btn.TabIndex == (whiteBtn.TabIndex - 1) || btn.TabIndex == (whiteBtn.TabIndex - 4) || btn.TabIndex == (whiteBtn.TabIndex + 1) || btn.TabIndex == (whiteBtn.TabIndex + 4))
            {
                whiteBtn.BackColor = Color.FromKnownColor
